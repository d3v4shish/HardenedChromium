...
TEST(PerformanceManagerPrefsTest,
     HardenedPrivacyModeForcesForegroundPriority) {
  base::test::ScopedFeatureList feature_list;
  feature_list.InitAndEnableFeature(blink::features::kHardenedPrivacyMode);

  EXPECT_TRUE(IsForceForegroundPriorityForAllTabsEnabled(nullptr));
}
