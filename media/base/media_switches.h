...
MEDIA_EXPORT extern const char kHardenedDefaultCameraSource[];
MEDIA_EXPORT extern const char kHardenedDefaultMicrophoneSource[];
MEDIA_EXPORT extern const char kHardenedPrivateCameraBackend[];
MEDIA_EXPORT extern const char kHardenedPrivateCameraName[];
MEDIA_EXPORT extern const char kHardenedSelectableMediaSources[];
MEDIA_EXPORT extern const char kHardenedUseSystemAudioInputWithFakeMedia[];
