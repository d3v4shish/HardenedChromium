...
// Hardened Chromium: keep platform microphone input available when fake media
// is used for video capture.
const char kHardenedDefaultCameraSource[] =
    "hardened-default-camera-source";
const char kHardenedDefaultMicrophoneSource[] =
    "hardened-default-microphone-source";
const char kHardenedPrivateCameraBackend[] =
    "hardened-private-camera-backend";
const char kHardenedPrivateCameraName[] = "hardened-private-camera-name";
const char kHardenedSelectableMediaSources[] =
    "hardened-selectable-media-sources";

const char kHardenedUseSystemAudioInputWithFakeMedia[] =
    "hardened-use-system-audio-input-with-fake-media";
