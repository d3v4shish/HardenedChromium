...
// Supplies the private geolocation source as latitude,longitude,accuracy.
// It does not bypass or grant the normal geolocation permission.
const char kHardenedFakeLocation[] = "hardened-fake-location";
