...
bool UtilityProcessHost::StartProcess() {
  ...
  static const char* const kSwitchNames[] = {
      ...
      switches::kHardenedDefaultCameraSource,
      switches::kHardenedDefaultMicrophoneSource,
      switches::kHardenedPrivateCameraBackend,
      switches::kHardenedPrivateCameraName,
