...
GraphTestHarnessWithDiscardablePage::GraphTestHarnessWithDiscardablePage()
  ...
  hardened_privacy_mode_feature_list_.InitAndDisableFeature(
...
void GraphTestHarnessWithDiscardablePage::
    EnableHardenedPrivacyModeForTesting() {
  hardened_privacy_mode_feature_list_.Reset();
  hardened_privacy_mode_feature_list_.InitAndEnableFeature(
      blink::features::kHardenedPrivacyMode);
}
