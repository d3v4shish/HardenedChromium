...
class HardenedBrowserViewTest : public BrowserViewTest {
 public:
  HardenedBrowserViewTest() {
    feature_list_.InitAndEnableFeature(blink::features::kHardenedPrivacyMode);
  }
...
class HardenedAppBackendBrowserViewTest : public BrowserViewTest {
 public:
  HardenedAppBackendBrowserViewTest() {
    feature_list_.InitAndEnableFeature(blink::features::kHardenedPrivacyMode);
    command_line_.GetProcessCommandLine()->AppendSwitchASCII(
        switches::kRemoteDebuggingPort, "0");
  }
...
class AppBackendWithoutPrivacyBrowserViewTest : public BrowserViewTest {
 public:
  AppBackendWithoutPrivacyBrowserViewTest() {
    feature_list_.InitAndDisableFeature(blink::features::kHardenedPrivacyMode);
    command_line_.GetProcessCommandLine()->AppendSwitchASCII(
        switches::kRemoteDebuggingPort, "0");
  }
...
class StandardBrowserViewTest : public BrowserViewTest {
 public:
  StandardBrowserViewTest() {
    feature_list_.InitAndDisableFeature(blink::features::kHardenedPrivacyMode);
  }
