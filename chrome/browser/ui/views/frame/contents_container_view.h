...
class ContentsContainerView : public views::View,
 ...
 public:
  ...
  const views::View* hardened_mode_border_view_for_testing() const {
    return hardened_mode_border_view_;
  }
 ...
 private:
  ...
  // Browser-owned visual indicator that hardened mode is active. This is an
  // overlay rather than part of the WebContents surface.
  raw_ptr<views::View> hardened_mode_border_view_ = nullptr;
