...
class PermissionPromptBubbleOneOriginView :
 ...
 private:
  ...
  // Adds a private/real source selector for location requests.
  bool MaybeAddHardenedLocationSourceSelector(
  ...
  raw_ptr<views::Combobox> location_source_combobox_ = nullptr;
